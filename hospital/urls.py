...
urlpatterns = [
    ...
    path("doctor/<int:pk>/book/",
         views.AppointmentCreateView.as_view(),
         name="appointment-create"
         ),
    path("appointments/my/",
         views.MyAppointmentsListView.as_view(),
         name="my-appointments"
         ),
    path("appointment/<int:pk>/cancel/",
         views.AppointmentCancelView.as_view(),
         name="appointment-cancel"
         ),
    path("appointments/<int:pk>/confirm/",
         views.AppointmentConfirmView.as_view(),
         name="appointment-confirm"
         ),
    path("appointments/<int:pk>/record/",
         views.MedicalRecordCreateView.as_view(),
         name="record-create"
         ),
    path("schedule/",
         views.DoctorScheduleView.as_view(),
